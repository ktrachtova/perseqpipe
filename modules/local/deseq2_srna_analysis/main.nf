process DESEQ2_SRNA_ANALYSIS {
    ...
    //path "dds_sncrna.rds", emit: deseq2_dds_sncrna, optional: true
    //path "dds_lrt_sncrna.rds", emit: deseq2_dds_lrt_sncrna, optional: true
    //path "de_analysis_sncrna.rds", emit: deseq2_env_sncrna
